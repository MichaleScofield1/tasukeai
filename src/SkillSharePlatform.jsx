          ...
          <div style={{ display: 'flex', gap: '16px' }}>
            <div style={{ flex: 1, position: 'relative' }}>
              ...
              <input
                type="text"
                placeholder="スレッドを検索..."
                style={{ width: '300px', paddingLeft: '40px', paddingRight: '16px', paddingTop: '8px', paddingBottom: '8px', border: '1px solid #d1d5db', borderRadius: '8px', outline: 'none' }}
                value={searchTerm}
            ...
            <div style={modalContentStyle} onClick={(e) => e.stopPropagation()}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <input
                  type="text"
                  placeholder="タイトル"
                  style={{ width: '90%', padding: '12px', border: '1px solid #d1d5db', borderRadius: '6px', outline: 'none' }}
                ...
                <textarea
                  placeholder="内容"
                  style={{ width: '90%', padding: '12px', border: '1px solid #d1d5db', borderRadius: '6px', height: '160px', outline: 'none' }}
